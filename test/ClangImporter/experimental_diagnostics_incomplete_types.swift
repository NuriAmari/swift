...
// CHECK: incomplete_types.h:{{[0-9]+}}:1: warning: method 'methodReturningForwardDeclaredInterface' not imported
...
// CHECK-NEXT: - (ForwardDeclaredInterface *) methodReturningForwardDeclaredInterface;
// CHECK-NEXT: ^
// CHECK-NEXT: incomplete_types.h:{{[0-9]+}}:1: note: interface 'ForwardDeclaredInterface' is incomplete
// CHECK-NEXT: - (ForwardDeclaredInterface *) methodReturningForwardDeclaredInterface;
// CHECK-NEXT: ^
// CHECK-NEXT: incomplete_types.h:{{[0-9]+}}:1: note: interface 'ForwardDeclaredInterface' forward declared here
...
// CHECK:     incomplete_types.h:{{[0-9]+}}:1: warning: method 'methodTakingAForwardDeclaredInterfaceAsAParameter:andAnother:' not imported
...
// CHECK-NEXT: ^
// CHECK-NEXT: incomplete_types.h:{{[0-9]+}}:59: note: parameter 'param1' not imported
// CHECK-NEXT: - (int)methodTakingAForwardDeclaredInterfaceAsAParameter:(ForwardDeclaredInterface *)param1 andAnother:(ForwardDeclaredInterface *)param2;
// CHECK-NEXT:                                                           ^
// CHECK-NEXT: incomplete_types.h:{{[0-9]+}}:59: note: interface 'ForwardDeclaredInterface' is incomplete
// CHECK-NEXT: - (int)methodTakingAForwardDeclaredInterfaceAsAParameter:(ForwardDeclaredInterface *)param1 andAnother:(ForwardDeclaredInterface *)param2;
// CHECK-NEXT:                                                           ^
// CHECK-NEXT: incomplete_types.h:{{[0-9]+}}:1: note: interface 'ForwardDeclaredInterface' forward declared here
// CHECK-NEXT: @class ForwardDeclaredInterface;
...
// CHECK: incomplete_types.h:{{[0-9]+}}:1: warning: property 'propertyUsingAForwardDeclaredInterface' not imported
...
// CHECK: incomplete_types.h:{{[0-9]+}}:1: warning: function 'CFunctionReturningAForwardDeclaredInterface' not imported
...
// CHECK: incomplete_types.h:{{[0-9]+}}:1: warning: function 'CFunctionTakingAForwardDeclaredInterfaceAsAParameter' not imported
...
// CHECK: incomplete_types.h:{{[0-9]+}}:1: warning: method 'methodReturningForwardDeclaredProtocol' not imported
// CHECK-NEXT: - (NSObject<ForwardDeclaredProtocol> *) methodReturningForwardDeclaredProtocol;
// CHECK-NEXT: ^
// CHECK-NEXT: incomplete_types.h:{{[0-9]+}}:1: note: return type not imported
// CHECK-NEXT: - (NSObject<ForwardDeclaredProtocol> *) methodReturningForwardDeclaredProtocol;
// CHECK-NEXT: ^
// CHECK-NEXT: incomplete_types.h:{{[0-9]+}}:1: note: protocol 'ForwardDeclaredProtocol' is incomplete
// CHECK-NEXT: - (NSObject<ForwardDeclaredProtocol> *) methodReturningForwardDeclaredProtocol;
// CHECK-NEXT: ^
// CHECK-NEXT: incomplete_types.h:{{[0-9]+}}:1: note: protocol 'ForwardDeclaredProtocol' forward declared here
...
// CHECK:     incomplete_types.h:{{[0-9]+}}:1: warning: method 'methodTakingAForwardDeclaredProtocolAsAParameter:' not imported
// CHECK-NEXT: - (int)methodTakingAForwardDeclaredProtocolAsAParameter:(id<ForwardDeclaredProtocol>)param1;
// CHECK-NEXT: ^
// CHECK-NEXT: incomplete_types.h:{{[0-9]+}}:58: note: parameter 'param1' not imported
// CHECK-NEXT: - (int)methodTakingAForwardDeclaredProtocolAsAParameter:(id<ForwardDeclaredProtocol>)param1;
// CHECK-NEXT:                                                          ^
// CHECK-NEXT: incomplete_types.h:{{[0-9]+}}:58: note: protocol 'ForwardDeclaredProtocol' is incomplete
// CHECK-NEXT: - (int)methodTakingAForwardDeclaredProtocolAsAParameter:(id<ForwardDeclaredProtocol>)param1;
// CHECK-NEXT:                                                          ^
// CHECK-NEXT: incomplete_types.h:{{[0-9]+}}:1: note: protocol 'ForwardDeclaredProtocol' forward declared here
// CHECK-NEXT: @protocol ForwardDeclaredProtocol;
...
// CHECK: incomplete_types.h:{{[0-9]+}}:1: warning: property 'propertyUsingAForwardDeclaredProtocol' not imported
...
// CHECK: incomplete_types.h:{{[0-9]+}}:1: warning: function 'CFunctionReturningAForwardDeclaredProtocol' not imported
...
// CHECK: incomplete_types.h:{{[0-9]+}}:1: warning: function 'CFunctionTakingAForwardDeclaredProtocolAsAParameter' not imported
